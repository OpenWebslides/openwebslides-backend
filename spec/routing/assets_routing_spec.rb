...
RSpec.describe 'assets routing', :type => :routing do
  it 'routes topic assets endpoint' do
  ...
  it 'routes topic assets raw endpoint' do
    route = '/api/topics/foo/assets/bar.png'
    params = { :topic_id => 'foo', :filename => 'bar.png' }

    expect(:get => route).to route_to 'assets#raw', params
